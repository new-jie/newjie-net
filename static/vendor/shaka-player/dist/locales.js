...
shaka.ui.Locales.addTo = function(localization) {
  ...
  localization.insert('en', new Map([
    ...
    ['PIP_WINDOW_ACTIVE', 'Playing in picture-in-picture mode'],
    ['PLAY', 'Play'],
  ...
  localization.insert('es', new Map([
    ...
    ['MACHINE_GENERATED', 'Generado'],
    ['MACHINE_TRANSLATED', 'Traducido'],
    ...
    ['PIP_WINDOW_ACTIVE', 'Reproduciendo en modo imagen en imagen'],
    ['PLAY', 'Reproducir'],
    ...
    ['VIDEO_MAIN', 'Principal'],
    ['VIDEO_SIGN', 'Lenguaje de signos'],
  ...
  localization.insert('fr', new Map([
    ...
    ['LIVE', 'En direct'],
    ['LOOP', 'Répéter'],
    ['MACHINE_GENERATED', 'Généré'],
    ['MACHINE_TRANSLATED', 'Traduit'],
    ...
    ['PAUSE', 'Pause'],
    ['PICTURE_IN_PICTURE', 'Picture-in-Picture'],
    ['PIP_WINDOW_ACTIVE', 'Lecture en mode Picture-in-Picture'],
    ['PLAY', 'Visionner'],
    ...
    ['VIDEO_MAIN', 'Principale'],
    ['VIDEO_SIGN', 'Langue des signes'],
  ...
  localization.insert('nl', new Map([
    ...
    ['AIRPLAY', 'AirPlay'],
    ['AUDIO_DESCRIPTION', 'Audiodescriptie'],
    ...
    ['OFF', 'Uit'],
    ['ON', 'Aan'],
    ['ORIGINAL_VERSION', 'Originele versie'],
    ['PAUSE', 'Onderbreken'],
    ['PICTURE_IN_PICTURE', 'Picture-in-picture'],
    ['PIP_WINDOW_ACTIVE', 'Afspelen in picture-in-picture mode'],
    ['PLAY', 'Afspelen'],
  ...
  localization.insert('pl', new Map([
    ...
    ['MACHINE_GENERATED', 'Wygenerowane'],
    ['MACHINE_TRANSLATED', 'Przetłumaczone'],
    ...
    ['OFF', 'Wyłączone'],
    ['ON', 'Włączone'],
    ['ORIGINAL_VERSION', 'Wersja oryginalna'],
    ['PAUSE', 'Wstrzymaj'],
    ['PICTURE_IN_PICTURE', 'Obraz w obrazie'],
    ['PIP_WINDOW_ACTIVE', 'Odtwarzanie w trybie obrazu w obrazie'],
    ['PLAY', 'Odtwórz'],
...
shaka.ui.Locales.Ids = {
  ...
  CHAPTERS: 'CHAPTERS',
  CAPTIONS: 'CAPTIONS',
  PIP_WINDOW_ACTIVE: 'PIP_WINDOW_ACTIVE',
  CENTER: 'CENTER',
  ...
  SURROUND: 'SURROUND',
  COPY_VIDEO_FRAME: 'COPY_VIDEO_FRAME',
  TOP_RIGHT: 'TOP_RIGHT',
  EXIT_FULL_SCREEN: 'EXIT_FULL_SCREEN',
  CENTER_RIGHT: 'CENTER_RIGHT',
  SUBTITLES_EXAMPLE: 'SUBTITLES_EXAMPLE',
